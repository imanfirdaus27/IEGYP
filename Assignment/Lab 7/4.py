...
def col(colour):  
    ...
    if colour[0] in colour:
        resistance_value += resistance[colour[0]]
    if colour[1] in colour:
        resistance_value += resistance[colour[1]]

    return resistance_value

colour = input("Enter the colour of resistance:").lower().split("-")
x = col(colour)
print(x)
