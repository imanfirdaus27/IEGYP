...
# to differentiate the variables from values/literal we use double quote ""
# or single quote ''
#product = "Television"
...
# type is another built in functiin that tell us what is the
...
# So the input value can be string which needs to be converted
quantity = "10"
print(type(quantity))
price = "1455.55"
...
firstNumber = 500 #statement
#how can  i see the address where the object 500 is
#In python we have built in function called "id"
print(id(firstNumber))# to know address location of serial light
secondNumber = 500 #statement
